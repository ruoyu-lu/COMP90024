...
int main(int argc, char** argv) {
    ...
    if(rank == 0) {
        ...
        for (int i = 1; i < size; i++) {
            ...
            MPI_Recv(data_hour_recv.data(), num_elements_hour, data_time_type, i, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
            MPI_Recv(data_day_recv.data(), num_elements_day, data_time_type, i, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
